...
| Architecture ablation: branch count | MIT-BIH and HAPT | Dendritic | Branches = 2, 4, 8, 12; branch width and trunk fixed | 3 exploratory seeds: 42, 0, 7 | Float32 and Snowflake accuracy; compression delta | Parameters and stored size | Desktop CPU | Implemented; results not yet rerun |
| Architecture ablation: branch width | MIT-BIH and HAPT | Dendritic | `hidden_per_branch` = 2, 4, 8, 16; branch count and trunk fixed | 3 exploratory seeds: 42, 0, 7 | Float32 and Snowflake accuracy; compression delta | Parameters and stored size | Desktop CPU | Implemented; results not yet rerun |
| Architecture ablation: trunk size | MIT-BIH and HAPT | Dendritic | Paired (`h1`, `h2`) = (16,8), (32,16), (64,32), (128,64); branch axes fixed | 3 exploratory seeds: 42, 0, 7 | Float32 and Snowflake accuracy; compression delta | Parameters and stored size | Desktop CPU | Implemented; results not yet rerun |
...
| Statistical equivalence | Each main dataset and applicable method | Dendritic and baselines | Compressed method paired with its own float32 model by seed | 10 paired seeds | Accuracy, macro-F1 and balanced-accuracy CI/TOST, margin &plusmn;2 percentage points | Mean paired difference; 95% CI; both one-sided p-values | Not applicable | Implemented; final results require rerun |
