...
*(Numbers above are from the pre-2026-07-27 `balance=True` runs, being re-confirmed against the current codebase — see the 2026-07-27 entry in `docs/experiment_log.md` for the in-progress verification run.)*
